...
const objLit = (obj) => {
  ...
  let first = obj.firstName.toUpperCase().slice(0,1) + obj.firstName.slice(1, obj.firstName.length);
  let last = obj.lastName.toUpperCase().slice(0,1) + obj.lastName.slice(1, obj.lastName.length);
  let output = `my name is ${first} ${last} I am ${obj.age} YO, and I love ${obj.hobby}.`;
  return output;
};
